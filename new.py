...
def search():
    ...
    if filtered_df.empty:
        ...
        return render_template('results.html', tables=None, message=message, keywords=query)

    return render_template('results.html', tables=[filtered_df.to_html()], keywords=query)
